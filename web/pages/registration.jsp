	...
	<!--<div class="signup-form">-->
		<div class="container register">
			...
			<div class="col-md-3 register-left">
				...
				<h3><fmt:message bundle="${message}" key="global.welcome"/></h3>
			</div>
		...
		<form accept-charset="UTF-8" action="${pageContext.request.contextPath}/controller1" method="post">
			...
			<div class="form-inline form-group">
				...
				<div>
					<input type="text" class="form-control" name="lastName"
						   ...
						   required="required" pattern="(\p{Lu}){1}(\p{Ll}{1,15})">
					<label class="text-muted"><fmt:message bundle="${message}" key="register.example"/> Zhekan</label>
				</div>
			</div>
			...
			<div class="form-group">
				<div class="text-center"><fmt:message bundle="${message}" key="register.texthelp_2"/> <a
						href="${pageContext.request.contextPath}/pages/login.jsp"><fmt:message bundle="${message}" key="login.button_login"/></a></div>
			</div>
				</div>
				</div>
			</div>
